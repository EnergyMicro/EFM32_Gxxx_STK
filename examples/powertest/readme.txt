Power test example, running demonstration of energy modes.
...
in Simplicity Studio can show the power consumption of each enery mode.

Board:  Energy Micro EFM32_Gxxx_STK Starter Kit
